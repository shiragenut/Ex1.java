...
public class Ex1Test {
    ...
    //Test method for 'int2Number' functionality (valid and invalid test cases
    @Test
    void int2NumberTest() {
    ...
    //Test method for the 'maxIndex' functionality (find the index of the max value)
    @Test
    void maxIndexTest() {
        String[] P = {"1, 2, 5, 10"}; //The input value
        int ans = 0; //To store the index of the max value
        int tempMax = 0; //Temporary variable to atore the current max value
        //Iterate through the array to find the max value and it's index
